#' Load Data
#' @name load_data
#' @description Takes the data from the lichess dataset on kaggle and converts them into rchess
#'     objects and then extracts desired information in a memory efficient manner
...
#' @param estimator the number of iterations used to predict the time until completion.
#' @return A list of games where each game is a list that includes the pgn, the history, and
#'     other traits for subsetting
#' @import rchess
#' @examples
#' print('FIXME LATER')
#' @export
